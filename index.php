...
<label>
<input type="submit" name="playerthrow" value="ROCK" id="throw_1">
</label>

<label>
<input type="submit" name="playerthrow" value="PAPER" id="throw_2">
</label>

<label>
<input type="submit" name="playerthrow" value="SCISSORS" id="throw_3">
</label>
